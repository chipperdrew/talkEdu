...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_eduuser', (
            ...
            ('user_type', self.gf('django.db.models.fields.CharField')(default='STU', max_length=3)),
            ...
            ('akismet_hits', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
        ))
        db.send_create_signal(u'accounts', ['eduuser'])

        # Adding M2M table for field groups on 'eduuser'
        m2m_table_name = db.shorten_name(u'accounts_eduuser_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('eduuser', models.ForeignKey(orm[u'accounts.eduuser'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['eduuser_id', 'group_id'])

        # Adding M2M table for field user_permissions on 'eduuser'
        m2m_table_name = db.shorten_name(u'accounts_eduuser_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('eduuser', models.ForeignKey(orm[u'accounts.eduuser'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'accounts_eduuser')

        # Removing M2M table for field groups on 'eduuser'
        db.delete_table(db.shorten_name(u'accounts_eduuser_groups'))

        # Removing M2M table for field user_permissions on 'eduuser'
        db.delete_table(db.shorten_name(u'accounts_eduuser_user_permissions'))
