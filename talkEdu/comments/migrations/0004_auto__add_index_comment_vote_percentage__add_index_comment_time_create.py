...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'comment', fields ['vote_percentage']
        db.create_index(u'comments_comment', ['vote_percentage'])

        # Adding index on 'comment', fields ['time_created']
        db.create_index(u'comments_comment', ['time_created'])

        # Adding index on 'comment', fields ['path']
        db.create_index(u'comments_comment', ['path'])

        # Adding index on 'comment', fields ['total_votes']
        db.create_index(u'comments_comment', ['total_votes'])


    def backwards(self, orm):
        # Removing index on 'comment', fields ['total_votes']
        db.delete_index(u'comments_comment', ['total_votes'])

        # Removing index on 'comment', fields ['path']
        db.delete_index(u'comments_comment', ['path'])

        # Removing index on 'comment', fields ['time_created']
        db.delete_index(u'comments_comment', ['time_created'])

        # Removing index on 'comment', fields ['vote_percentage']
        db.delete_index(u'comments_comment', ['vote_percentage'])
