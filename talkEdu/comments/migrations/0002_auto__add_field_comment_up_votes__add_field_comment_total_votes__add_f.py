...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'comment.up_votes'
        db.add_column(u'comments_comment', 'up_votes',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'comment.total_votes'
        db.add_column(u'comments_comment', 'total_votes',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'comment.vote_percentage'
        db.add_column(u'comments_comment', 'vote_percentage',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'comment.up_votes'
        db.delete_column(u'comments_comment', 'up_votes')

        # Deleting field 'comment.total_votes'
        db.delete_column(u'comments_comment', 'total_votes')

        # Deleting field 'comment.vote_percentage'
        db.delete_column(u'comments_comment', 'vote_percentage')
