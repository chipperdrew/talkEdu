...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'comment.votes_by_user_type'
        db.add_column(u'comments_comment', 'votes_by_user_type',
                      self.gf('picklefield.fields.PickledObjectField')(default={'STU': [0, 0, 0], 'PAR': [0, 0, 0], 'ADM': [0, 0, 0], 'OUT': [0, 0, 0], 'TEA': [0, 0, 0]}),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'comment.votes_by_user_type'
        db.delete_column(u'comments_comment', 'votes_by_user_type')
    ...
    models = {
        ...
        u'comments.comment': {
            ...
            'time_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 3, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'time_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 3, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'total_votes': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'up_votes': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
