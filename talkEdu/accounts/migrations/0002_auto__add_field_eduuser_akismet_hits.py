...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'eduuser.akismet_hits'
        db.add_column(u'accounts_eduuser', 'akismet_hits',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'eduuser.akismet_hits'
        db.delete_column(u'accounts_eduuser', 'akismet_hits')
