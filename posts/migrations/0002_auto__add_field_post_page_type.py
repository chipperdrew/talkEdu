...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'post.page_type'
        db.add_column(u'posts_post', 'page_type',
                      self.gf('django.db.models.fields.CharField')(default='PRO', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'post.page_type'
        db.delete_column(u'posts_post', 'page_type')
