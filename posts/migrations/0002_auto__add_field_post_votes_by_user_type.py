...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'post.votes_by_user_type'
        db.add_column(u'posts_post', 'votes_by_user_type',
                      self.gf('picklefield.fields.PickledObjectField')(default={'STU': [0, 0, 0], 'PAR': [0, 0, 0], 'ADM': [0, 0, 0], 'OUT': [0, 0, 0], 'TEA': [0, 0, 0]}),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'post.votes_by_user_type'
        db.delete_column(u'posts_post', 'votes_by_user_type')
