...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'post', fields ['vote_percentage']
        db.create_index(u'posts_post', ['vote_percentage'])

        # Adding index on 'post', fields ['page_type']
        db.create_index(u'posts_post', ['page_type'])

        # Adding index on 'post', fields ['time_created']
        db.create_index(u'posts_post', ['time_created'])

        # Adding index on 'post', fields ['total_votes']
        db.create_index(u'posts_post', ['total_votes'])


    def backwards(self, orm):
        # Removing index on 'post', fields ['total_votes']
        db.delete_index(u'posts_post', ['total_votes'])

        # Removing index on 'post', fields ['time_created']
        db.delete_index(u'posts_post', ['time_created'])

        # Removing index on 'post', fields ['page_type']
        db.delete_index(u'posts_post', ['page_type'])

        # Removing index on 'post', fields ['vote_percentage']
        db.delete_index(u'posts_post', ['vote_percentage'])
