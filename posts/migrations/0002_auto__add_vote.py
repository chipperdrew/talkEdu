...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'posts_vote', (
            ('post_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['posts.post'], unique=True, primary_key=True)),
            ('stu_votes', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('tea_votes', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('par_votes', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('adm_votes', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('out_votes', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
    ...
    models = {
        ...
        u'posts.vote': {
            ...
            'adm_votes': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'out_votes': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'par_votes': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'post_id': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['posts.post']", 'unique': 'True', 'primary_key': 'True'}),
            'stu_votes': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'tea_votes': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        }
    }
