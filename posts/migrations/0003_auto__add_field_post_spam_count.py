...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'post.spam_count'
        db.add_column(u'posts_post', 'spam_count',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'post.spam_count'
        db.delete_column(u'posts_post', 'spam_count')
    ...
    models = {
        ...
        u'posts.post': {
            ...
            'time_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 14, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'time_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 14, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
