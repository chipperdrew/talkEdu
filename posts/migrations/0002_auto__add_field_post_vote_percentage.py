...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'post.vote_percentage'
        db.add_column(u'posts_post', 'vote_percentage',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'post.vote_percentage'
        db.delete_column(u'posts_post', 'vote_percentage')
    ...
    models = {
        ...
        u'posts.post': {
            ...
            'time_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 13, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'time_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 13, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
