...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'comments_comment', 'content')

        # Adding field 'comment.comment'
        db.add_column(u'comments_comment', 'comment',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'comments_comment', 'content',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)

        # Deleting field 'comment.comment'
        db.delete_column(u'comments_comment', 'comment')
