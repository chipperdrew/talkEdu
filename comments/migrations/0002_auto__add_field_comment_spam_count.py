...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'comment.spam_count'
        db.add_column(u'comments_comment', 'spam_count',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'comment.spam_count'
        db.delete_column(u'comments_comment', 'spam_count')
